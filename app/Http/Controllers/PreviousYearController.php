...
class PreviousYearController extends Controller
{
    public function index()
    {
        $photos = [
            ...
            ['year' => "২০২৪", 'src' => asset('images/gallery/2024/1.JPG'), 'caption' => 'সংবর্ধনা অনুষ্ঠানের দৃশ্য'],
            ['year' => "২০২৪", 'src' => asset('images/gallery/2024/2.JPG'), 'caption' => 'সংবর্ধনা অনুষ্ঠানের দৃশ্য'],
            ['year' => "২০২৪", 'src' => asset('images/gallery/2024/3.JPG'), 'caption' => 'সংবর্ধনা অনুষ্ঠানের দৃশ্য'],
            ['year' => "২০২৪", 'src' => asset('images/gallery/2024/4.JPG'), 'caption' => 'সংবর্ধনা অনুষ্ঠানের দৃশ্য'],
            ['year' => "২০২৪", 'src' => asset('images/gallery/2024/26.JPG'), 'caption' => 'সংবর্ধনা অনুষ্ঠানের মুহূর্ত'],
            ['year' => "২০২৪", 'src' => asset('images/gallery/2024/5.JPG'), 'caption' => 'সংবর্ধনা অনুষ্ঠানের দৃশ্য'],
            ['year' => "২০২৪", 'src' => asset('images/gallery/2024/6.JPG'), 'caption' => 'সংবর্ধনা অনুষ্ঠানের দৃশ্য'],
            ['year' => "২০২৪", 'src' => asset('images/gallery/2024/7.JPG'), 'caption' => 'সংবর্ধনা অনুষ্ঠানের দৃশ্য'],
            ['year' => "২০২৪", 'src' => asset('images/gallery/2024/8.JPG'), 'caption' => 'সংবর্ধনা অনুষ্ঠানের দৃশ্য'],
        ];
        ...
        $newsList = [
            ...
            ['year' => "২০২৫", 'title' => 'নাম্বার ওয়ান বাবার কৃতী সন্তান সংবর্ধনা', 'date' => '০৪ জুন ২০২৪ | ২০:০০', 'image' => asset('images/gallery/2024/5.JPG'), 'excerpt' => 'মেঘনা গ্রুপ অব ইন্ডাস্ট্রিজের জনপ্রিয় ব্র্যান্ড নাম্বার ওয়ানের সৌজন্যে গতকাল সোমবার (৩ জুন) রাজধানীর এক অভিজাত হোটেলে নাম্বার ওয়ান বাবার কৃতী সন্তান সংবর্ধনা ২০২৪ অনুষ্ঠিত হয়। ', 'link' => 'https://www.ntvbd.com/economy/news-1411205'],
            ['year' => "২০২৫", 'title' => '৫০ কৃতী শিক্ষার্থীর পরিবারকে মেঘনা গ্রুপের সংবর্ধনা', 'date' => '০৪ জুন ২০২৪, ১৯:৩৭', 'image' => asset('images/news/3.jpg'), 'excerpt' => 'এ বছর এসএসসি পরীক্ষায় কৃতিত্বের স্বাক্ষর রাখা ৫০ জন শিক্ষার্থীর পরিবারকে সংবর্ধনা দিয়েছে মেঘনা গ্রুপ অব ইন্ডাস্ট্রিজ।', 'link' => 'https://www.banglatribune.com/press-release/849865'],
        ];
