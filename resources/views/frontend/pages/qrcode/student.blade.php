    ...
    <div class="qr-page-bg">
        <div class="container">
                    ...
                    <div class="col-lg-5 col-md-7">
                        <div class="qr-card" id="printableCard">
                            ...
                            <div class="qr-print-header">
                                <div class="qr-print-header-logo">নাম্বার ওয়ান বাবার কৃতী সন্তান সংবর্ধনা ২০২৬</div>
                            ...
                            <div class="qr-card-body">
                                ...
                                <div class="qr-info-grid">
                                    ...
                                    <div class="qr-info-item">
                                        ...
                                        <div class="qr-info-value">{{ $user->studentDetail->registration_number ?? '—' }}
                                        </div>
                                    </div>
                                    <div class="qr-info-item">
                                        <div class="qr-info-label"><i class="fas fa-star"></i> জিপিএ</div>
                                        <div class="qr-info-value text-success">
                                            {{ $user->studentDetail->gpa_result ?? '—' }}</div>
                                    </div>
                                    <div class="qr-info-item">
                                ...
                                <div class="qr-print-cutline">
                                    ...
                                    নাম্বার ওয়ান বাবার কৃতী সন্তান সংবর্ধনা ২০২৬ · শিক্ষার্থীর প্রবেশ QR কোড · এই QR কোডটি
                                    প্রবেশের সময় দেখান
                                </div>
                            </div>
                        </div>
            ...
            @else
                ...
                <div class="qr-page-bar">
                    <div class="qr-page-bar-title">
                        <span class="qr-page-bar-icon"
                            style="background: linear-gradient(135deg, #c8393b 0%, #9c2224 100%);">
