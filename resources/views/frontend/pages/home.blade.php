    ...
    <div class="container">
        <div class="row align-items-center g-4 g-lg-5">
            <div class="col-lg-7 text-center text-lg-start" data-aos="fade-up">
                ...
                <p class="lead text-secondary mt-3 mt-lg-4">এসএসসি ২০২৬ ও সমমানের মেধাবী শিক্ষার্থীদের জন্য স্বপ্নের পথচলা, বৃত্তি ও আন্তর্জাতিক মানের ডিজিটাল কোর্স উপহার</p>
                <div class="d-flex flex-wrap gap-3 mt-4 justify-content-center justify-content-lg-start">
                    <a href="#" class="btn btn-primary btn-lg px-4 px-lg-5">এখনই নিবন্ধন <i class="bi bi-chevron-right"></i></a>
            ...
            <div class="col-lg-5 text-center floating-element">
                <img src="{{ asset('images/hero-image.png') }}" alt="hero" class="img-fluid rounded-4 shadow-lg" style="max-width: 92%;">
            </div>
        </div>
    </div>
</section>
...
<section class="container py-4 py-md-5 my-2 my-md-4 text-center">
    <div class="row justify-content-center">
        <div class="col-11 col-lg-8">
            ...
            <p class="lead mt-4 fs-5 fs-md-4 fw-medium text-dark-emphasis">“শিক্ষাই মূল চাবিকাঠি। প্রতিটি ঘরের মেধাবী সন্তান যেন তার স্বপ্নের পথে অগ্রসর হতে পারে—নং ১ সেই লক্ষ্যেই এগিয়ে যায়। আমরা গর্বিত তোমাদের সাফল্যে।”</p>
            <img src="{{ asset('images/no1-logo.png') }}" alt="brand" height="45" class="mt-3">
        </div>
    </div>
</section>
...
<section class="bg-light py-5 py-md-6 mt-3 mt-md-5">
    <div class="container">
        <div class="text-center mb-4 mb-md-5">
            ...
            <p class="text-secondary px-2">জিপিএ-৫ প্রাপ্ত প্রতিটি শিক্ষার্থী পাচ্ছে অত্যাধুনিক আইটি কোর্স ও সার্টিফিকেট</p>
        </div>
        <div class="row g-3 g-md-4">
            <div class="col-12 col-md-4">
                <div class="card-premium h-100 p-3 p-md-4 text-center">
                    ...
                    <h4 class="fs-5 fs-md-4">থিংক এআই কোর্স</h4>
                    <p class="text-secondary small">কৃত্রিম বুদ্ধিমত্তার মৌলিক ধারণা, ChatGPT, প্রম্পট ইঞ্জিনিয়ারিং</p>
            ...
            <div class="col-12 col-md-4">
                <div class="card-premium h-100 p-3 p-md-4 text-center">
                    ...
                    <h4 class="fs-5 fs-md-4">ডিজিটাল টুলস মাস্টারি</h4>
                    <p class="text-secondary small">এক্সেল, কন্টেন্ট ক্রিয়েশন, ফ্রিল্যান্সিং বেসিক</p>
            ...
            <div class="col-12 col-md-4">
                <div class="card-premium h-100 p-3 p-md-4 text-center">
                    ...
                    <h4 class="fs-5 fs-md-4">ক্যারিয়ার বুটক্যাম্প</h4>
                    <p class="text-secondary small">কলেজ সিলেকশন, ইউনিভার্সিটি ভর্তি ও ক্যারিয়ার কাউন্সেলিং</p>
                    <a href="#" class="video-play-btn text-primary fw-bold" data-video-id="SxR6m7kqP9M">🎓 মেন্টরশিপ সেশন</a>
                </div>
            </div>
        </div>
        
        <!-- Fancy Feature Badges Row - Mobile Responsive -->
        <div class="row mt-4 mt-md-5 g-3 g-md-4 justify-content-center">
            <div class="col-6 col-md-3">
                <div class="fancy-feature-card text-center p-3 p-md-4 rounded-4 bg-white shadow-sm hover-lift">
                    ...
                    <h5 class="fw-bold mb-0 mb-md-1 fs-6 fs-md-5">মেধা বৃত্তি</h5>
                    <p class="small text-secondary mb-0 d-none d-md-block">আর্থিক সহায়তা</p>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="fancy-feature-card text-center p-3 p-md-4 rounded-4 bg-white shadow-sm hover-lift">
                    <div class="fancy-icon-wrapper bg-gradient-success mx-auto mb-2 mb-md-3">
                        <i class="bi bi-patch-check fs-2 fs-md-1 text-white"></i>
                    </div>
                    <h5 class="fw-bold mb-0 mb-md-1 fs-6 fs-md-5">সার্টিফিকেট</h5>
                    <p class="small text-secondary mb-0 d-none d-md-block">আন্তর্জাতিক মানের</p>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="fancy-feature-card text-center p-3 p-md-4 rounded-4 bg-white shadow-sm hover-lift">
                    <div class="fancy-icon-wrapper bg-gradient-warning mx-auto mb-2 mb-md-3">
                        <i class="bi bi-star fs-2 fs-md-1 text-white"></i>
                    </div>
                    <h5 class="fw-bold mb-0 mb-md-1 fs-6 fs-md-5">টপ মেন্টরশিপ</h5>
                    <p class="small text-secondary mb-0 d-none d-md-block">স্পেশালাইজড গাইড</p>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="fancy-feature-card text-center p-3 p-md-4 rounded-4 bg-white shadow-sm hover-lift">
                    <div class="fancy-icon-wrapper bg-gradient-info mx-auto mb-2 mb-md-3">
                        <i class="bi bi-book fs-2 fs-md-1 text-white"></i>
                    </div>
                    <h5 class="fw-bold mb-0 mb-md-1 fs-6 fs-md-5">শিক্ষা উপকরণ</h5>
                    <p class="small text-secondary mb-0 d-none d-md-block">প্রিমিয়াম রিসোর্স</p>
                </div>
            </div>
        </div>
    </div>
...
<section id="eligibility" class="container py-4 py-md-5 my-3 my-md-5">
    <div class="row g-4 g-lg-5 align-items-stretch">
        <div class="col-12 col-lg-7">
            <div class="bg-white rounded-4 shadow-sm p-4 p-md-5 h-100 border border-light">
                <div class="d-flex align-items-center gap-3 mb-4">
                    <div class="bg-primary bg-opacity-10 rounded-circle p-2 p-md-3"><i class="bi bi-check2-circle fs-3 fs-md-2 text-primary"></i></div>
                ...
                <div class="mt-3 mt-md-4">
                    <div class="d-flex gap-3 mb-3 mb-md-4 pb-2 border-bottom">
                        ...
                        <div><strong class="fs-6 fs-md-5">২০২৬ সালের এসএসসি/সমমান</strong><br><span class="text-secondary small">পরীক্ষায় উত্তীর্ণ নিয়মিত শিক্ষার্থীরা আবেদন করতে পারবেন।</span></div>
                    </div>
                    <div class="d-flex gap-3 mb-3 mb-md-4 pb-2 border-bottom">
                        <i class="bi bi-check-circle-fill text-primary fs-6 fs-md-5 mt-1"></i>
                        <div><strong class="fs-6 fs-md-5">জেএসসি ও এসএসসি উভয় স্তরের ফলাফল</strong><br><span class="text-secondary small">মেধা তালিকা তৈরি হবে মোট নম্বরের ভিত্তিতে। জিপিএ-৫ বাধ্যতামূলক।</span></div>
                    </div>
                    <div class="d-flex gap-3 mb-3 mb-md-4 pb-2 border-bottom">
                        <i class="bi bi-check-circle-fill text-primary fs-6 fs-md-5 mt-1"></i>
                        <div><strong class="fs-6 fs-md-5">সঠিক তথ্য প্রদান আবশ্যক</strong><br><span class="text-secondary small">অনলাইন ফরমে তথ্যের অমিল পাওয়া গেলে আবেদন বাতিল হবে।</span></div>
                    </div>
                    <div class="d-flex gap-3">
                        <i class="bi bi-check-circle-fill text-primary fs-6 fs-md-5 mt-1"></i>
                        <div><strong class="fs-6 fs-md-5">কোটা সুবিধা প্রাপ্তি</strong><br><span class="text-secondary small">উপযুক্ত প্রমাণপত্র সাবমিট করতে হবে।</span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-5">
            <div class="bg-gradient-special rounded-4 p-4 p-md-5 h-100 d-flex flex-column justify-content-between" style="background: linear-gradient(135deg, #FEF3C7 0%, #FDE68A 100%);">
                ...
                <p class="fs-6 fs-md-5 text-dark-emphasis mt-2 mt-md-3">অনলাইন নিবন্ধনকারী প্রতিটি শিক্ষার্থী <strong class="text-primary">সেন্ট্রাল ক্যারিয়ার ওরিয়েন্টেশন ইভেন্টে</strong> আমন্ত্রিত। সেরা মেন্টরদের সাথে সরাসরি মতবিনিময়।</p>
                <div class="mt-3 mt-md-4">
                    <button class="btn btn-dark btn-md btn-lg rounded-pill px-4 px-md-5 shadow-sm w-100 w-md-auto">আসন নিশ্চিত করুন <i class="bi bi-arrow-right ms-2"></i></button>
                </div>
...
<section id="timeline" class="py-5 py-md-6 mt-3 mt-md-5" style="background: linear-gradient(to bottom, #F8FAFC, #FFFFFF);">
    <div class="container">
        <div class="text-center mb-4 mb-md-5">
            <div class="d-inline-flex align-items-center gap-2 bg-white px-3 px-md-4 py-2 rounded-pill shadow-sm mb-3 mb-md-4">
        ...
        <div class="row g-3 g-md-5 justify-content-center">
            <div class="col-6 col-md-3">
                <div class="timeline-card-modern text-center p-3 p-md-4 rounded-4 bg-white border-bottom border-4 border-warning shadow-sm h-100">
            ...
            <div class="col-6 col-md-3">
                <div class="timeline-card-modern text-center p-3 p-md-4 rounded-4 bg-white border-bottom border-4 border-primary shadow-sm h-100">
            ...
            <div class="col-6 col-md-3">
                <div class="timeline-card-modern text-center p-3 p-md-4 rounded-4 bg-white border-bottom border-4 border-success shadow-sm h-100">
            ...
            <div class="col-6 col-md-3">
                <div class="timeline-card-modern text-center p-3 p-md-4 rounded-4 bg-white border-bottom border-4 border-danger shadow-sm h-100">
    ...
    <div class="row g-3 g-md-4">
        <div class="col-12 col-md-6">
            <div class="video-thumb rounded-4 overflow-hidden shadow-lg" data-video-id="jg-EvmKaqTQ">
                <img src="https://cdn.10minuteschool.com/images/thumbnails/skills/ghore-boshe-Spoken-English-course-thumbnail-by-Munzereen-Shahid-16x9.jpg" class="w-100" style="height: 200px; object-fit: cover;">
                <div class="play-btn-overlay"><i class="bi bi-play-fill text-white"></i></div>
            </div>
            <p class="mt-2 mt-md-3 fw-bold text-center fs-6 fs-md-5 px-2">“এই উদ্যোগ আমাকে এআই শেখার সুযোগ করে দিয়েছে” <br class="d-none d-md-block">— রাইসা, চাঁপাইনবাবগঞ্জ</p>
        </div>
        <div class="col-12 col-md-6">
            <div class="video-thumb rounded-4 overflow-hidden shadow-lg" data-video-id="dQw4w9WgXcQ">
                <img src="https://cdn.10minuteschool.com/images/catalog/media/ASE-Thumbnail-16%C3%A0%C2%A6%C2%8F%C3%A0%C2%A6%C2%95%C3%A0%C2%A7%C2%8D%C3%A0%C2%A6%C2%B89_1780465442289.png" class="w-100" style="height: 200px; object-fit: cover;">
                <div class="play-btn-overlay"><i class="bi bi-play-fill"></i></div>
            </div>
            <p class="mt-2 mt-md-3 fw-bold text-center fs-6 fs-md-5 px-2">সেরা কলেজ পেতে কৌশল - সাফল্যের সাক্ষী রাফসান</p>
        </div>
    </div>
</section>
        ...
        <div class="row g-3 g-md-4">
            <div class="col-12 col-md-4">
                <div class="video-thumb rounded-4 overflow-hidden" data-video-id="SxR6m7kqP9M">
                    <img src="https://ncdn.ntvbd.com/sites/default/files/styles/big_3/public/images/2024/06/05/mgi.jpg" class="w-100" style="height: 180px; object-fit: cover;">
                    <div class="play-btn-overlay"><i class="bi bi-play-fill"></i></div>
                </div>
            ...
            <div class="col-12 col-md-4">
                <div class="video-thumb rounded-4 overflow-hidden" data-video-id="jg-EvmKaqTQ">
                    <img src="https://admin.dainikamadershomoy.com/images/large/2025/08/31/news_1756661557436.webp" class="w-100" style="height: 180px; object-fit: cover;">
                    <div class="play-btn-overlay"><i class="bi bi-play-fill"></i></div>
                </div>
            ...
            <div class="col-12 col-md-4">
                <div class="video-thumb rounded-4 overflow-hidden" data-video-id="dQw4w9WgXcQ">
                    <img src="https://scontent.fdac198-2.fna.fbcdn.net/v/t39.30808-6/481478843_1013384197492318_1529058912000844589_n.jpg" class="w-100" style="height: 180px; object-fit: cover;">
                    <div class="play-btn-overlay"><i class="bi bi-play-fill"></i></div>
                </div>
...
<section id="gallery" class="container py-5 py-md-6 mt-3 mt-md-5">
    ...
    <div class="gallery-main-container">
        <img id="galleryMain" src="" alt="Gallery Main" class="gallery-main-img w-100 rounded-4 shadow-lg" style="height: auto; max-height: 400px; min-height: 250px; object-fit: cover;">
            ...
            <div class="col-11 col-lg-8">
                <div class="accordion" id="faqAccordion">
                    <div class="accordion-item border-0 mb-2 mb-md-3 shadow-sm rounded-4 overflow-hidden">
                        <h2 class="accordion-header"><button class="accordion-button rounded-4 fw-semibold small fs-6 fs-md-5 py-3" data-bs-toggle="collapse" data-bs-target="#faq1">অনলাইন নিবন্ধনের শেষ সময় কখন?</button></h2>
                        <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion"><div class="accordion-body text-secondary small">১৫ মার্চ ২০২৬ পর্যন্ত নিবন্ধন চলবে। এর পরে কোনো সুযোগ থাকবে না।</div></div>
                    </div>
                    <div class="accordion-item border-0 mb-2 mb-md-3 shadow-sm rounded-4 overflow-hidden">
                        <h2 class="accordion-header"><button class="accordion-button collapsed rounded-4 fw-semibold small fs-6 fs-md-5 py-3" data-bs-toggle="collapse" data-bs-target="#faq2">ফ্রি কোর্স কিভাবে পাব?</button></h2>
                        <div id="faq2" class="accordion-collapse collapse"><div class="accordion-body text-secondary small">নিবন্ধনের ২৪ ঘণ্টার মধ্যে আপনার ইমেইল ও মোবাইল নম্বরে কোর্স অ্যাক্সেস লিংক পাঠিয়ে দেওয়া হবে।</div></div>
                    </div>
                    <div class="accordion-item border-0 shadow-sm rounded-4 overflow-hidden">
                        <h2 class="accordion-header"><button class="accordion-button collapsed rounded-4 fw-semibold small fs-6 fs-md-5 py-3" data-bs-toggle="collapse" data-bs-target="#faq3">মেধা তালিকায় স্থান পাওয়ার নিয়ম?</button></h2>
                        <div id="faq3" class="accordion-collapse collapse"><div class="accordion-body text-secondary small">জেএসসি ও এসএসসি মোট নম্বরের ভিত্তিতে মেধাক্রম নির্ধারণ করা হবে। জিপিএ-৫ থাকা আবশ্যক।</div></div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="container my-4 my-md-5 py-3 py-md-4">
    <div class="bg-gradient-contact rounded-4 p-4 p-md-5 text-center text-md-start shadow-lg" style="background: linear-gradient(120deg, #EFF6FF 0%, #FFFFFF 100%);">
        <div class="row align-items-center g-3 g-md-4">
            <div class="col-12 col-md-8">
                <h3 class="fw-bold fs-3 fs-md-2">আপনার প্রশ্ন আছে?</h3>
                <p class="fs-6 fs-md-5 text-secondary mb-2 mb-md-3">আমাদের সাপোর্ট টিম ২৪/৭ নিয়োজিত আছে আপনার যেকোনো সমস্যার সমাধানে।</p>
                <div class="d-flex flex-wrap gap-3 gap-md-4 mt-2 mt-md-3 justify-content-center justify-content-md-start">
                    <div class="small"><i class="bi bi-telephone-fill text-primary me-2"></i> <strong>০১৯৮৮-৭৬৫৪৩২</strong></div>
                    <div class="small"><i class="bi bi-envelope-fill text-primary me-2"></i> <strong>support@babarkritisontan.com</strong></div>
                    <div class="small"><i class="bi bi-whatsapp text-success me-2"></i> <strong>০১৭XX-XXXXXX</strong></div>
                </div>
            </div>
            <div class="col-12 col-md-4 text-center mt-3 mt-md-0">
                <img src="https://randomuser.me/api/portraits/men/32.jpg" class="rounded-circle shadow-lg border border-white border-3" width="90" height="90" style="object-fit: cover;">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content bg-black border-0 rounded-4">
            <div class="modal-body p-0 position-relative" style="padding-top: 56.25%;">
                ...
                <button type="button" class="btn-close btn-close-white position-absolute top-0 end-0 m-2 m-md-3" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
        </div>
    </div>
</div>
...
<style>
    ...
    .bg-gradient-primary { background: linear-gradient(135deg, #5f1727, #f02367); }
    .bg-gradient-success { background: linear-gradient(135deg, #10B981, #037c56); }
    .bg-gradient-warning { background: linear-gradient(135deg, #F59E0B, #b46307); }
    .bg-gradient-info { background: linear-gradient(135deg, #06B6D4, #06667e); }
